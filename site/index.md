...
hero:
  name: "Unified Filters"
  text: "Framework Portal"
  tagline: One shared contract · two platforms · every filterable&nbsp;surface
---

<div class="vp-doc home-section" style="max-width: 900px; margin: 0.5rem auto 0;">
...
<div class="vp-doc home-section" style="max-width: 900px; margin: 2.5rem auto 0;">
...
<div class="vp-doc" style="max-width: 720px; margin: 3rem auto 0; text-align: center;">
  <p style="color: var(--vp-c-text-2)">
    Users learn filtering <strong>once</strong> — and every tool behaves the same.
    The always-current source of truth lives in-repo:
    <code>pgf/feature/filters/CLAUDE.md</code> and <code>android/filters/CLAUDE.md</code>.
  </p>
</div>
